        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="flex justify-end mb-6">
            <div className="inline-flex items-center bg-teal-500/10 border border-teal-500/30 px-3 py-1 rounded-full text-sm">
              ...
              <span className="text-teal-300">RERA Registered Project</span>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="md:w-1/2">
              ...
              {pageInfo?.subheading && (
                <p className="text-slate-300 mb-6">{pageInfo.subheading}</p>
              )}
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <span className="text-slate-300 text-sm">RERA ID</span>
                    <p className="text-white font-medium">{reraData.rera_id}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <span className="text-slate-300 text-sm">Project Area</span>
                    <p className="text-white font-medium">
            ...
            <div className="md:w-1/2">
                ...
                <div className="p-6">
                  <div className="mb-6">
                    <h4 className="text-white font-semibold mb-4 flex items-center">
                      <FileText size={18} className="text-teal-400 mr-2" />
                  ...
                  <a
                    ...
                    className="inline-flex w-full items-center justify-center bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600 active:from-teal-700 active:to-emerald-700 text-white text-sm font-medium px-4 py-3 rounded-lg transition-all duration-200 transform hover:-translate-y-1 shadow-lg shadow-teal-900/20"
                  >
              ...
              {/* CTA Card */}
              <div className="mt-6 bg-slate-800/80 rounded-xl p-6 border border-slate-700">
                <h4 className="text-white font-medium mb-2">
                  Need More Information?
                </h4>
                <p className="text-slate-300 text-sm mb-4">
                  Request detailed property documents and specifications for
