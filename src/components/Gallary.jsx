...
const Lightbox = ({ images, currentIndex, setCurrentIndex, closeLightbox }) => {
  ...
  useEffect(() => {
    const handleGlobalClick = (e) => {
      ...
      if (
        ...
        // Prevent closing when clicking navigation buttons or close button
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/95 z-50 flex items-center justify-center">
      {/* Container with half screen height and centered */}
      <div className="bg-slate-800 rounded-lg border border-slate-700 w-1/2 h-1/2 max-h-[50vh] relative flex flex-col">
